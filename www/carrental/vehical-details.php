...
--->
        	...
        	<div class="form-group">
  <input class="date" id="datepicker1"  type="text"  name="fromdate" placeholder="From Date" required>
			</div>
            
			<div class="form-group">
   <input class="date" id="datepicker"  type="text"  name="todate" placeholder="To Date" required>
            </div>
